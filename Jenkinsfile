pipeline {
	...
	stage('QualityTest') { 
		    ...
		    sh '(cd ./SpringTestDemo/; mvn sonar:sonar -Dsonar.projectKey=projkey -Dsonar.organization=organi -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=e800ab354b87736aaef7152b13db882e01bd6763)'
	    }
        }
